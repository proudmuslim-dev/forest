...
mod tests {
    ...
    mod public {
        ...
        fn orders() {
            ...
            let _orders: Orders = serde_json::from_str(j).unwrap();
        }
    }

    #[cfg(test)]
    mod private {
        use crate::api::model::private::*;
        ...
        fn order_history() {
            ...
            let _order_history: Vec<OrderHistory> = serde_json::from_str(j).unwrap();
        }
